...
var defaultMsg = `
<html><body><style>body{background-color:lightGray;} h1{margin:0 auto;width:600px;padding:100px;text-align:center;} a{color:#4e4e4e;text-decoration:none;} h3{float:right;}</style><h1><a href="http://github.com/ciju/gotunnel">github.com/ciju/gotunnel</a></h1><h3>Sponsored by ActiveSphere</h3></body></html>
`
